...
class page_extractor:
    ...
    def __init__(self, base, search_query, keyword):
        self.base = base
...
# search_query + keyword to search
...
for keyword in keywords:
    p_extractor = page_extractor(base=base, search_query=search_query, keyword=keyword)
    p_extractor.extract()
